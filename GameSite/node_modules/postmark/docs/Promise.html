...
<head>
	<meta charset="utf-8">
	<title>Postmark.js Class: Promise</title>
...
<dt>
    <h4 class="name" id="Promise"><span class="type-signature"></span>new Promise<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>A node.js Promise. This is returned if a callback is not provided when making a call to the API.</p>
    </div>
